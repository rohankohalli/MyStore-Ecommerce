            ...
            <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-sm">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    ...
                    <input name="name" className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none"
                        value={form.name} onChange={handleChange} placeholder="Enter Name" required />
                    ...
                    <input type="tel" name="mobileNo" className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none"
                        value={form.mobileNo} onChange={handleChange} placeholder="Enter mobile No" required />
                    ...
                    <button disabled={loading}
                        className="bg-green-500 text-white py-2 rounded-lg font-semibold cursor-pointer">
