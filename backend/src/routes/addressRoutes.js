...
import { addAddressValidation, deleteAddressValidation, getAddressValidation, setDefaultAddressValidation, updateAddressValidation } from "../validation/address.validation.js";
import { validate } from "../middleware/validator.js";

const router = express.Router()

router.get("/", authenticateToken, getAddressValidation, validate, getAddress)
